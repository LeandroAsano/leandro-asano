...
public class Game {
    ...
    public static String showInstructions(){
        String instruccions;
        instruccions= "Two players take turns either taking one or two sticks. \n" +
                "The player who takes the last stick loses. \n" +        //Shows the instructions of the game
                "Simple right? \n";
        return instruccions;
    }

    public static Player[] arrayGenerate(int cantplay){
    ...
    public static void newGame(){
        ...
        Player array[] = arrayGenerate(cantplay);
        ...
        while (sticks > 0) {
            ...
            System.out.println("GamePack.Player " + (playerturn + 1) + " turn");
            ...
            sticks -= choice;
            //this part controls the playerturn assignment
            if (sticks > 0) {
